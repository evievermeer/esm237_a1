...
```{r}
# running t-tests to test for significantly different means between early 2000s and late 2000s 
t_test_summer_temps <- t.test(slt_temp_early$summer,slt_temp_late$summer, paired=TRUE)
