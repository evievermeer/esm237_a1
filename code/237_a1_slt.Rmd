...
```{r}
# dividing dataframes for precipitation and temperature into two time periods

slt_precip_early <- subset(slt_precip_seasonal, year >= 2000 & year <= 2010)
slt_precip_late <- subset(slt_precip_seasonal, year >= 2011 & year <= 2022)


slt_temp_early <- subset(slt_temps_seasonal, year >= 2000 & year <= 2010)
slt_temp_late <- subset(slt_temps_seasonal, year >= 2011 & year <= 2022)
```
